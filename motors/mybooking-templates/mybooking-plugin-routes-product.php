...
<?php get_header();?>
        ...
        <!-- Header photo -->
        <div class="entry-header center small_title_box" style="background-color: #0a0a0a;background-image: url('/wp-content/mybooking-templates/vehicles-detail.jpg');">
                <div class="container">
        ...
        <!-- Product -->
        <div class="container product-container" style="margin-top: 80px !important">
          <div class="row">
            <div class="col-md-7">
                  ...
                  <div class="p-3">
                    ...
                    <div class="card-body  key-characteristics">
                      <ul class="icon-list-items">
                        <?php if ( isset( $args->characteristic_length ) && !empty( $args->characteristic_length ) ) { ?>
                          <li class="icon-list-item">
                              <span class="icon-list-icon">
                                 <img src="<?php echo esc_url( '/wp-content/plugins/mybooking-reservation-engine/assets/images/characteristics/length.svg' ) ?>"/>
                              </span>
                        ...
                        <li class="icon-list-item">
                            <span class="icon-list-icon">
                              <img src="<?php echo esc_url( '/wp-content/plugins/mybooking-reservation-engine/assets/images/key_characteristics/'.$mybooking_key.'.svg' ) ?>"/>
                            </span>
